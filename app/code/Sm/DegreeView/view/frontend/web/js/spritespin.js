(function (global, factory) {
    ...
    function getComputedSize(data) {
        ...
        var media_width = $$2('.product.media').width();
        if( parseInt(media_width)>0 ) {
            size.width = Math.floor(Number(media_width));
...
// tslint:disable:only-arrow-functions
    ...
    (function () {
        ...
        function onInit(e, data) {
            ...
            state.doubleClickTime = getOption(data, 'zoomDoubleClickTime', 1000);
