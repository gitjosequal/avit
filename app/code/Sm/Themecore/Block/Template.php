...
class Template extends \Magento\Framework\View\Element\Template
{
    ...
    public function _prepareLayout()
    {
		...
		$minicartAction = $helper_config->getAdvanced('minicart_group/show_minicart');
		...
		if ($minicartAction = "click") { 
            $this->pageConfig->addBodyClass('action-click-dropcart');
        }
		elseif ($minicartAction = "hover") { 
            $this->pageConfig->addBodyClass('action-hover-dropcart'); 
        }
